...
import 'package:stacked_bmi_app/ui/views/home/home_view.dart' as _i2;
import 'package:stacked_bmi_app/ui/views/result/result_view.dart' as _i4;
import 'package:stacked_bmi_app/ui/views/startup/startup_view.dart' as _i3;
...
class ResultViewArguments {
  ...
  @override
  String toString() {
    return '{"bmi": "$bmi", "key": "$key"}';
  }

  @override
  bool operator ==(covariant ResultViewArguments other) {
    if (identical(this, other)) return true;
    return other.bmi == bmi && other.key == key;
  }

  @override
  int get hashCode {
    return bmi.hashCode ^ key.hashCode;
  }
}
...
extension NavigatorStateExtension on _i6.NavigationService {
  ...
  Future<dynamic> navigateToResultView({
    ...
    return navigateTo<dynamic>(Routes.resultView,
        arguments: ResultViewArguments(bmi: bmi, key: key),
        id: routerId,
        preventDuplicates: preventDuplicates,
        parameters: parameters,
        transition: transition);
